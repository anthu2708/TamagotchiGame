...
public abstract class Pet implements Writable {
    ...
    // EFFECTS: Initializes the pet's name, type, hunger, happiness, cleanliness,
    // and health levels.
    ...
    // MODIFIES: this
    // EFFECTS: Changes happiness when petted; if already full, happiness remains
    // the same.
    ...
    // MODIFIES: this
    // EFFECTS: Increases the pet's hunger level when fed; if already full, hunger
    // remains the same.
    ...
    // MODIFIES: this
    // EFFECTS: Uses a pill, adjusting happiness, health, and hunger levels, injury
    // status accordingly.
    ...
    // EFFECTS: Returns true if the pet's health is below 20, indicating it needs a
    // pill.
